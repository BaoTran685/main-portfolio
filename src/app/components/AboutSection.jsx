...
const aboutComponets = [
  ...
  },
  {
    tab: "education",
    tabName: "Education",
    list: "High School Diploma, Bachelor of Mathematics, Exam B",
  },
  {
    tab: "certification",
    ...
    <section className="text-white mt-12 py-8 px-2 sm:py-18 xl:px-16">
      <div className="flex flex-col md:grid md:grid-cols-2 md:gap-10 xl:gap-14 items-center md:items-start">
        <Image
          ...
          height={500}
        />
        <div className="flex flex-col h-full items-center md:items-start md:text-left mt-4 md:mt-0">
          <h2 className="text-4xl lg:text-5xl font-extrabold mb-3 lg:mb-4">
            About Me
          </h2>
          <p className="text-base lg:text-lg xl:text-xl 2xl:text-2xl">
            I am Quoc Bao Tran, I am from Prince Edward Island, Canada. I am
            currently studying Mathematics at the Universtiy of Waterloo, and my
            major is Actuarial Science. I have a great passion for Website
            Development and looking forward to any opportunities!
          </p>
          ...
          <ul className="mt-3 lg:mt-5 list-disc md:pl-2">
            {aboutComponets
              ...
              .list.split(", ")
              .map((e, index) => (
                <li key={index} className="text-base lg:text-lg xl:text-xl 2xl:text-2xl mb-1">
                  {e}
                </li>
              ))}
          </ul>
